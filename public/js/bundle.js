...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"twoFactorVerify.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var myCart = exports.myCart = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          _context.prev = 6;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)("error", "Please login first!");
          window.setTimeout(function () {
...
var myCartBtn = document.querySelector(".nav-cart");
...
},{"./alerts":"alerts.js","./login":"login.js","./twoFactorVerify":"twoFactorVerify.js","./cart":"cart.js","./search":"search.js","./updateSettings":"updateSettings.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
