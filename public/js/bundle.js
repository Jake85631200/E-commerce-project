    ...
    "utils/alerts.js": [
      function (require, module, exports) {
        ...
        var showAlert = (exports.showAlert = function showAlert(type, msg) {
          var t = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1.5;
          // 清除舊的 alert
          hideAlert();
          var alert;
          // create 新的 alert
 ...
 */
    ...
    "../../node_modules/axios/lib/adapters/fetch.js": [
      function (require, module, exports) {
        ...
        const supportsResponseStream =
          isReadableStreamSupported && test(() => _utils.default.isReadableStream(new Response("").body));
        const resolvers = {
    ...
    "user-auth/login.js": [
      ...
      { axios: "../../node_modules/axios/index.js", "../utils/alerts": "utils/alerts.js" },
    ],
    "user-auth/signup.js": [
      function (require, module, exports) {
        "use strict";
    ...
    "utils/updateButtonText.js": [
      function (require, module, exports) {
        ...
        exports.updateButtonText = void 0;
        var updateButtonText = (exports.updateButtonText = function updateButtonText(selector, text) {
          document.querySelector(selector).textContent = text;
        });
      },
      {},
    ],
    "user-auth/twoFactorVerify.js": [
      function (require, module, exports) {
        "use strict";
        ...
        var _axios = _interopRequireDefault(require("axios"));
        var _alerts = require("../utils/alerts");
        var _updateButtonText = require("../utils/updateButtonText");
        function _interopRequireDefault(e) {
          return e && e.__esModule ? e : { default: e };
        }
        function _typeof(o) {
        ...
        var sendTwoFACode = /*#__PURE__*/ (function () {
          var _ref = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(email) {
              var res;
              return _regeneratorRuntime().wrap(
                function _callee$(_context) {
                  while (1)
        ...
        var checkTwoFACode = /*#__PURE__*/ (function () {
          var _ref2 = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(function _callee2(email, verifyCode) {
              var res;
              return _regeneratorRuntime().wrap(
                function _callee2$(_context2) {
                  while (1)
          ...
          return function checkTwoFACode(_x2, _x3) {
            return _ref2.apply(this, arguments);
          };
        })();
        var resetPassword = /*#__PURE__*/ (function () {
          var _ref3 = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(function _callee3(email, newPassword, passwordConfirm) {
              var res;
              return _regeneratorRuntime().wrap(
        ...
        var initForgetPassword = (exports.initForgetPassword = function initForgetPassword() {
          ...
          if (sendEmailForm) {
            sendEmailForm.addEventListener(
              "submit",
              /*#__PURE__*/ (function () {
                    ...
                    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                      while (1)
                        switch ((_context4.prev = _context4.next)) {
                          ...
                          case 9:
                            (0, _updateButtonText.updateButtonText)(".send-verification", "Send verification code");
                          case 10:
                          case "end":
          ...
          if (sendVerifyForm) {
            sendVerifyForm.addEventListener(
              "submit",
              /*#__PURE__*/ (function () {
                var _ref5 = _asyncToGenerator(
                  /*#__PURE__*/ _regeneratorRuntime().mark(function _callee5(e) {
                      ...
                      while (1)
                        switch ((_context5.prev = _context5.next)) {
                          ...
                          case 6:
                            ...
                            (0, _updateButtonText.updateButtonText)(".code-verifying", "Verify");
                          case 9:
                          case "end":
      ...
      },
      {
        ...
        "../utils/alerts": "utils/alerts.js",
        "../utils/updateButtonText": "utils/updateButtonText.js",
      },
    ],
    "search-item/search.js": [
      function (require, module, exports) {
        "use strict";
        ...
        var initSearch = (exports.initSearch = function initSearch() {
          ...
          if (searchBarForm) {
            searchBarForm.addEventListener(
              "submit",
              /*#__PURE__*/ (function () {
                var _ref2 = _asyncToGenerator(
    ...
    "user-account/updateSettings.js": [
      function (require, module, exports) {
        "use strict";
                    ...
                    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                      while (1)
                        switch ((_context2.prev = _context2.next)) {
                          case 0:
                            e.preventDefault();
                            (0, _updateButtonText.updateButtonText)(".save-password", "Updating...");
                          ...
                          case 7:
                            (0, _updateButtonText.updateButtonText)(".save-password", "Save password");
    ...
    "user-cart/cartFunction.js": [
      function (require, module, exports) {
        ...
        exports.updateAllCheckbox =
          exports.setQuantity =
          exports.getCheckedItem =
          exports.deleteItem =
          exports.calCheckout =
        ...
        var addToCartRequest = (exports.addToCartRequest = /*#__PURE__*/ (function () {
          var _ref = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(productId) {
              var res;
              return _regeneratorRuntime().wrap(
                function _callee$(_context) {
                  while (1)
        ...
        var deleteItem = (exports.deleteItem = /*#__PURE__*/ (function () {
          var _ref2 = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(function _callee2(productId) {
              var res;
              return _regeneratorRuntime().wrap(
                function _callee2$(_context2) {
                  while (1)
    ...
    "stripe.js": [
      function (require, module, exports) {
        ...
        var orderProducts = (exports.orderProducts = /*#__PURE__*/ (function () {
          var _ref = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(productsId, productsQty) {
              var session;
              return _regeneratorRuntime().wrap(
                function _callee$(_context) {
                  while (1)
      ...
      { "./utils/alerts": "utils/alerts.js", axios: "../../node_modules/axios/index.js" },
    ],
    "user-cart/cart.js": [
      function (require, module, exports) {
        "use strict";
      ...
      {
        "../utils/alerts": "utils/alerts.js",
        "../user-cart/cartFunction": "user-cart/cartFunction.js",
        "../stripe": "stripe.js",
      },
    ],
    "product-review/review-render.js": [
      function (require, module, exports) {
        "use strict";
    ...
    "product-review/review.js": [
      function (require, module, exports) {
        ...
        var leaveReview = /*#__PURE__*/ (function () {
          var _ref = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(productId, review, rating) {
              var res;
              return _regeneratorRuntime().wrap(
                function _callee$(_context) {
                  while (1)
      ...
      },
      {
        axios: "../../node_modules/axios/index.js",
        "../utils/alerts": "utils/alerts.js",
        "./review-render": "product-review/review-render.js",
      },
    ],
    "index.js": [
      function (require, module, exports) {
      ...
      {
        "./utils/alerts": "utils/alerts.js",
        "./user-auth/login": "user-auth/login.js",
        "./user-auth/signup": "user-auth/signup.js",
        "./user-auth/twoFactorVerify": "user-auth/twoFactorVerify.js",
        "./search-item/search": "search-item/search.js",
        "./user-account/updateSettings": "user-account/updateSettings.js",
        "./user-cart/cart": "user-cart/cart.js",
        "./product-review/review": "product-review/review.js",
      },
    ],
